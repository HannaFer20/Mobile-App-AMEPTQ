...
import '../juegoMario/components/bottom_navbar.dart';
import '../juegoMario/components/dialogos_cocina.dart';
import 'ganaste.dart';
          ...
          Align(
            ...
            child: Column(
              ...
              children: [
                ...
                Image.asset(
                  'images/juegoMario/Titulo.png', // Asegúrate de que este título exista o ajústalo
                  height: 100, 
                        ...
                        child: SingleChildScrollView( // Anidamos para scroll horizontal también
                          ...
                          child: Stack(
                            children: [
                              ...
                              Image.asset(
                                'images/juegoMario/kitchen_background.png',
              ...
              child: Row(
                ...
                children: _objectsToDisplay.map((objectName) {
                  ...
                  return Opacity(
                    ...
                    child: Image.asset(
                      'images/juegoMario/$objectName.png', // Usa tus imágenes de objetos individuales
                      width: 50,
                      height: 50,
